...
final class CharacterDetailViewModel: ObservableObject {
    ...
    var type: String { character.type.isEmpty ? "N/A" : character.type }
    var origin: String { character.originName }
    var location: String { character.locationName }
    var episodesCount: String { "\(character.episodeCount)" }
